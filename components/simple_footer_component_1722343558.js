...
*/
Vue.component("simple_footer_component_1722343558", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your creativity with CarpetCraft, the ultimate app for designing and visualizing custom carpets. Explore patterns, colors, and materials to bring your unique flooring ideas to life.
                    </div>
                </div>
            </div>
        </footer> 
